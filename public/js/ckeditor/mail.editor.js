(function()
{
    if ( !CKEDITOR.plugins.get('justifygroup'))
        CKEDITOR.plugins.add('justifygroup', {
            requires: "menubutton,justify",
            hidpi: true,
            tabToOpen:null,
    ...
    $('#message').ckeditor({
        toolbarGroups : [ { name: 'basicstyles', groups: [ 'basicstyles', 'cleanup' ] },
            { name: 'paragraph',   groups: [ 'list', 'indent'/*, 'blocks'*/ /*, 'bidi'*//*, 'justifygroup'*/] },
           ...
           /* { name: 'justify', groups : ['align']}*/
        ],
        /*extraPlugins : 'justify',*/
        /*extraPlugins : 'justifygroup',*/
        removeDialogTabs : 'link;link:advanced'

     });

    CKEDITOR.scriptLoader.load( '/user/urlbcard'  );
                ...
                elements: [{
                    ...
                    children: [{
                        ...
                        children: [{
                            ...
                            type : 'button',
                            id : 'bcard',
                            style : 'background:url(/favicon.png); width: 16px; height: 16px; margin-top:17px;',
                            title : c.businessCard,
                            onClick : function () {
                                var d = CKEDITOR.dialog.getCurrent();
                                d.setValueOf('info', 'protocol', InternPagesSelectBox[0]);
                                d.setValueOf('info', 'url', InternPagesSelectBox[1]);
                            }
                        }],
                        setup: function() {
